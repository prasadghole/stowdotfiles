...
# Standard Ubuntu/WSL prompt style with Git branch appended safely
export PS1="\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[32m\]\$(br=\$(parse_git_branch); if [ -n \"\$br\" ]; then echo \" (\$br)\"; fi)\[\033[00m\]\$ "
